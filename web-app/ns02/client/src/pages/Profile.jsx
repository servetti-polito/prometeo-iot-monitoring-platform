...
import { Alert, Button, Spinner, Pagination, Container, Row, Col } from "react-bootstrap";
...
export default function Profile(props) {
  ...
  return (
    <Container id="Profile" className="text-center">
      ...
      {props.NO_DASH ? (
        <Row className="mt-2 mb-2" style={{ fontSize: "100% !important" }}>
          <Col xs={4} />
          <Col xs={4}>
            <Button
              id="profileButton"
            ...
            >
              {props.ita ? "Area Personale" : "Personal"}
            </Button>
          </Col>
          <Col xs={4} />
        </Row>
