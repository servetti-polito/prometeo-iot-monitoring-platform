    ...
    if (
      ...
      API.submitAnswers(props.answers)
        ...
        .catch((err) => {
          ...
          setError(
            props.ita
              ? "Si è verificato un errore: " + JSON.stringify(err)
              : "An error occourred: " + JSON.stringify(err)
          );
          console.error("Error submitting survey answers\nServer data - " + err)
          console.error("Error submitting survey answers\nClient data - logged: " + props.logged + " error: " + error + " answers: " + props.answers + " anon: " + props.anon);

        });
    } else {
      setLoading(false);
      console.error("Error submitting data - logged: " + props.logged + " error: " + error + " answers: " + props.answers + " anon: " + props.anon);
    }
  }, []);
